              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <?php $content = strip_tags($about->content); ?>
	                  <tr>
                      <td>{{$about->id}}</td>
	                    <td>{{$about->pagename}}</td>
	                    <td>{{$about->pagetitle}}</td>
	                    <td>{{$content}}</td>
	                    
	                    <td>
	                    	<!-- <a href=""><i class="fa fa-eye" aria-hidden="true"></i></a> | -->
	                    	<a href="{{route('about.edit',['id' => $about->id])}}"><i style="color: #c49f47;" class="fas fa-pen-square"></i></a> |
	                    	<a href="{{route('about.delete' , ['id' => $about->id])}}"><i style="color: #bd0a0a;" class="fa fa-trash" aria-hidden="true"></i></a> 
