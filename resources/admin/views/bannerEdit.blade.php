...
<div class="card card-primary card-outline">
          <div class="card-header">
            ...
            <h3 class="card-title">
              ...
              Banner Add Details to Banner Page
            </h3>
              ...
              <form action="{{route('banner.update',['id' => $banner->id])}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" required="" name="title" id="exampleInputPassword1" value="{{$banner->title}}" placeholder="Title">
                  </div>
                  ...
                  <div class="form-group">
                   ...
                   @if($banner->image != null)
                      <img style="width: 250px; height: 150px;object-fit: contain;" src="{{asset('adminTheme/uploads/homeslider')}}/{{$banner->image}}">
                    @else
